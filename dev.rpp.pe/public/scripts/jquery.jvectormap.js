...
jvm.Proj = {
   ...
   * projection
   * @see {@link http://mathworld.wolfram.com/AlbersEqual-AreaConicProjection.html">Alber}
   * @param {Number} lat Latitude in degrees
   * @param {Number} lng Longitude in degrees
   * @param {Number} c Central meridian in degrees
   */
   ...
   * projection
   * @see {@link http://mathworld.wolfram.com/AlbersEqual-AreaConicProjection.html}
   * @param {Number} x X of point in Cartesian system as integer
   * @param {Number} y Y of point in Cartesian system as integer
   * @param {Number} c Central meridian in degrees
   */
   ...
   * conic projection
   * @see {@link http://mathworld.wolfram.com/LambertConformalConicProjection.html}
   * @param {Number} lat Latitude in degrees
   * @param {Number} lng Longitude in degrees
   * @param {Number} c Central meridian in degrees
   */
