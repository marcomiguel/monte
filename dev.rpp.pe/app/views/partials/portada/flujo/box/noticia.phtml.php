<?php var_dump(\Rpp\Services\Get\Content::node($nid))?>
   <div class="col-1-2">
        <article class="box">
          <div class="box-inner">
            <header>
              <div class="tag-time">
                <h3 class="tag"><span><i class="icon icon-photo"> </i><a href="<?php echo \Rpp\Services\Get\Content::nurl($nid); ?><?php echo \Rpp\Services\Get\UrlTrack::add_params($position); ?>"><?php echo \Rpp\Services\Get\Content::node($nid)->categoria['nombre']; ?></a></span></h3>
