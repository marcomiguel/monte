...
class Tvenvivo extends \Rpp\Pages\Page {
    ...
    public function __construct() {
        ...
        $this->tipon = 'video';
        $this->tipop = 'streamST1TV';
        $this->file = "rtmp://rpplivefs.fplive.net/rpp02live-live/streamRPPWC";        
        $this->player = \Rpp\Services\Get\Player::player('tv');
        $this->urlcanonical ='/tvenvivo';
        $this->cover = "";
    }
