...
app.register.controller('fotosCtrl', [
    '$scope',
    '$http',
    '$location',
    '$preload',
        ...
        */
        ...
        ng.initList = function(data) {
            ...
            ng.obtenerMultimedia = function($event, tipo, nuevo) {
                ...
                $http.post(URL + URLMULTIMEDIA + 'photo?cursor=' + ng.newsAfter, DATA).
            ...
            ng.abrirDetalle = function($event, modal, indice){
                ...
                $mdDialog.show({
                    targetEvent: $event,
                    templateUrl: CMSDATA.GLOBAL.URLTEMPLATE + 'modal/fotos/detail.html',
