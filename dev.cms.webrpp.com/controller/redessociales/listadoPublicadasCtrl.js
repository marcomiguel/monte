...
define(['app'], function (app) {
  ...
  app.register.controller('listadoPublicadasCtrl', [
    '$scope',
    '$rootScope',
    '$http',
    '$document',
    ...
    function(
      ...
      $popup
        ...
        var URL = CMSDATA.GLOBAL.URLBASE,
            ...
            URLLISTNEWS = 'redessociales/posts/',
        ...
        ng.mostrarVistaDetalle = function($event, nid){
            // editar o agregar
            nid ? $location.path('/redessociales/publicada/'+nid) : $location.path('/redessociales/publicada/');
        };
