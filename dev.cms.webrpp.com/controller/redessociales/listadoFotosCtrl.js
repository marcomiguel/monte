...
app.register.controller('listadoFotosCtrl', [
    '$scope',
    '$rootScope',
    '$http',
    '$document',
    ...
    function(
        ...
        URLLISTNEWS = 'redessociales/posts_fotos',
        ...
        ng.mostrarVistaDetalle = function($event, nid){
            // editar o agregar
            nid ? $location.path('/redessociales/foto/'+nid) : $location.path('/redessociales/foto/');
        };
