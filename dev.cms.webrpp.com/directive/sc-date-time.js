      ...
      controller: [
        '$scope', 'scDateTimeI18n', function(scope, scDateTimeI18n) {
          ...
          scope.setDate = function(newVal, save) {
            ...
            scope.clock._seconds = scope.date.getSeconds();
          ...
          scope.clock = {
            ...
            _incSeconds: function(inc) {
              this._seconds = Math.max(0, Math.min(59, this._seconds + inc));
          ...
          scope.$watch('clock._seconds', function(val, oldVal) {
            if ((val != null) && val !== scope.date.getSeconds() && !isNaN(val) && (0 <= val && val <= 59)) {
              scope.date.setSeconds(val);
              return scope.saveUpdateDate();
            }
          });
