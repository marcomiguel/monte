...
t.html5imageupload = function(r, i) { //e, this
	...
	this.options.heightOrientation = function(orientation, _width){
		...
		if(orientation === 'horizontal'){
			...
			return { height: Math.round((parseInt(_width, 10)*16)/9), width: _width };
		}
	};
...
t.html5imageupload.prototype = {
	...
	imageCrop: function() {
		...
		var o;
		//if(isHorizontal){
			o = s.width != t(n).outerWidth() ? s.width / t(n).outerWidth() : 1;
		//}else{
		//	o = e.options.heightOrientation('horizontal', s.width).height != t(n).outerWidth() ? e.options.heightOrientation('vertical', s.width).height / t(n).outerWidth() : 1;
		//}
		//var o = s.width != t(n).outerWidth() ? s.width / t(n).outerWidth() : 1; //ORIGINAL
	...
	imageOrientation: function() {
		...
		if(!isH){
			...
			t(r).css({height: String(e.options.heightOrientation('horizontal', n.width).height) ,width: n.width });
		}else{
